...
class LetterboxThumbnails {
    ...
    function letterboxing_settings_interface() {
        ...
        wp_register_style('colorpicker_css1', plugins_url('/colorpicker/css/colorpicker.css', __FILE__));
        wp_enqueue_style('colorpicker_css1');
        wp_register_style('colorpicker_css2', plugins_url('/colorpicker/css/layout.css', __FILE__));
        wp_enqueue_style('colorpicker_css2');
        ?>
