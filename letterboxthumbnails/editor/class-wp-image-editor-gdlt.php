 ...
 */
class WP_Image_Editor_GDLT extends WP_Image_Editor {
    ...
    public function multi_resize($sizes) {
        ...
        foreach ($sizes as $size => $size_data) {
            ...
            if (!is_wp_error($image)) {
                $resized = $this->_save($image, $size_data['width'], $size_data['height']);
    ...
    protected function _save($image, $max_width, $max_height, $filename = null, $mime_type = null) {
